...
desc:<i>"Eyes on target, preparing for attack "</i></></><b>Stats and Stuff:</><.>Each wand is producing <#33ff00>[floor(cats)].[(catss*pow(10,N))%pow(10,N)] cats</#> cats per second</><.>Playing with cats heightens agility and speed</b>
